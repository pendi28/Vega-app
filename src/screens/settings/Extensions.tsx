...
import FacebookFollowGate, {isFacebookFollowed} from '../../components/FacebookFollowGate';
import {
  View,
  Text,
  TouchableOpacity,
...
const Extensions = ({navigation}: Props) => {
  ...
  const [showFbGate, setShowFbGate] = useState<boolean>(!isFacebookFollowed());
  ...
  return (
    <>
      <FacebookFollowGate
        visible={showFbGate}
        onFollowed={() => setShowFbGate(false)}
      />
